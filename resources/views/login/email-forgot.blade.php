                ...
                <table border="0" width="600" cellpadding="0" cellspacing="0" class="container"
                    ...
                    <tr>
                        <td class="container-padding header" align="left"
                            style="font-family:Roboto, Arial, sans-serif;font-size:20px;font-weight:bold;padding-bottom:1em;color:#fff;padding-left:24px;padding-right:24px;padding-top: 1em;background-color: #9900cc">
                            <span style="float: right;">RESET PASSWORD</span>
                        </td>
                    </tr>
                    <tr>
                        <td class="container-padding content" align="left" style="padding-left:24px;padding-right:24px;padding-top:12px;padding-bottom:12px;background-color:#ffffff;background: url('#')no-repeat;background-size: 70%;background-position: center;border-bottom: solid 1em #9900cc;">
                                ...
                                <div  align="center" style="margin-bottom: 48px;margin-top: 30px;">
                                    <a href="{{ $datas['url_reset'] }}" style="text-decoration: none;font-size: 18px;" >
                                        <div style="padding: 15px 0px 15px 0px; background-color: #9900cc; text-align: center; color: white; width: 200px;" >
                                            Reset Password
                                        </div>
                                    </a>
                                </div>
